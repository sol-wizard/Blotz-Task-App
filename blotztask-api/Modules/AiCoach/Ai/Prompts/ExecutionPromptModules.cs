...
public static class ExecutionPromptModules
{
    ...
    public static readonly PromptModuleDefinition ModeExecution = new(
        ...
        - When you receive a goal or anything vague, use strategy ask_clarifying_question: your ENTIRE reply must be exactly one short question that helps the user pick a first concrete piece. No suggestions, no proposed times, no lists, no card. One question only.
