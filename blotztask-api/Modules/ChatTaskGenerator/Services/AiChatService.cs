    ...
    : IAiChatService
{
        ...
        CancellationToken ct)
    {
        ...
        // No tool called means the user's message had nothing task-shaped. That is a valid
        // empty result, not a fault — fall through and return it on the normal success path.
