...
- If no end time is explicitly stated or strongly implied by the user input, set the end_time field to an empty string.
- Do NOT invent, guess, or assign any default end_time values.
