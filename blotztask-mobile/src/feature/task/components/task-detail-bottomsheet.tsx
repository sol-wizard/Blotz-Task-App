...
const TaskDetailBottomSheet = forwardRef<TaskDetailBottomSheetHandle, TaskDetailBottomSheetProps>(
            ...
            <>
              ...
              {task?.startTime ? (
                <View className="flex-row items-center mb-2">
                  ...
                  <Text className="ml-2.5 text-base leading-5 text-gray-900">{task.startTime}</Text>
                  <Text className="ml-2.5 text-base leading-5 text-gray-500">→</Text>
                  {task?.endTime ? (
                    <Text className="ml-2 text-base leading-5 text-gray-900">{task.endTime}</Text>
                  ) : null}
                </View>
              ) : task?.endTime ? (
                <View className="flex-row items-center mb-2">
                  <MaterialIcons name="calendar-today" size={18} color="#6B7280" />
                  <Text className="ml-2.5 text-base leading-5 text-gray-900">{task.endTime}</Text>
                </View>
              ) : null}
