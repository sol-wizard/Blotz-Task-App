...
>(({ task, onDismiss, onChange }, ref) => {
  ...
  const mockSubtasks = [
    { id: 1, subtask: "Define Goals & Project List", content: "Define Goals & Project List", estimatedDuration: "1h", isCompleted: false },
    { id: 2, subtask: "Content Drafting",             content: "Define Goals & Project List", estimatedDuration: "2h", isCompleted: false },
    { id: 3, subtask: "Visual Asset Preparation",     content: "Define Goals & Project List", estimatedDuration: "2h", isCompleted: true  },
    { id: 4, subtask: "Platform Update",              content: "Define Goals & Project List", estimatedDuration: "2h", isCompleted: false },
    { id: 5, subtask: "Review & Resume Alignment",    content: "Define Goals & Project List", estimatedDuration: "1h", isCompleted: false },
  ];
