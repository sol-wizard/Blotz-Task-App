...
const CalendarBottomSheet: React.FC<CalendarBottomSheetProps> = ({
  ...
  // Flat gray pill tag component
  const Tag = ({ children }: { children: React.ReactNode }) => (
    <View
      className="h-7 px-3 rounded-xl bg-gray-200 items-center justify-center"
    >
                ...
                <View className="flex-row items-center justify-between mb-2">
                  ...
                  <View className="flex-row items-center" style={{ columnGap: 8 }}>
                    ...
                    >
                      ...
                      <Text style={{ fontSize: 10, fontWeight: 'bold' }} className="ml-1.5 text-gray-900">
                        AI Breakdown
                      </Text>
                    </TouchableOpacity>
                  </View>
