    ...
    <Modal transparent visible animationType="fade" statusBarTranslucent onRequestClose={onDismiss}>
      <View className="flex-1 bg-black/50 items-center justify-center px-8">
        <View className="w-full items-center">
          ...
          <Text className="text-highlight text-2xl font-baloo mb-4">
          ...
          <View className="bg-lime-100 rounded-full px-4 py-1.5 mb-2">
            <Text className="text-secondary text-xl font-bold font-baloo text-center">
              {badge.name}
            </Text>
          </View>

          <Text className="text-white text-sm font-balooThin text-center max-w-[260px]">
            {badge.description}
          </Text>

          <Text className="text-white text-xs font-baloo mt-4">
