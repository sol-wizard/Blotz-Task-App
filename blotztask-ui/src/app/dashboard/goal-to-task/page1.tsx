...
//   const { createAndConfigureConnection, connectionState, invoke, error } = useSignalR();
...
//   console.log('[SignalR] connectionState', connectionState);
//   // SignalR: Log connection start/stop
//   useEffect(() => {
//     const connect = createAndConfigureConnection();
...
//       connect
//       .stop()
//         .then(() => console.log('[SignalR] Connection stopped', { error, isOfflineMode, connectionError }));
//     };
//   }, []);
