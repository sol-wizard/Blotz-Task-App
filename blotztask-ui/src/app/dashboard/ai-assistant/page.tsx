...
import GoalToTasksDemo from './goal-to-tasks';
        ...
        {extractedTasks?.tasks?.length !== 0 &&
          extractedTasks?.tasks
            ...
            .map((extractedTask, index) => (
              <Card
                key={index}
                className={`p-4 shadow-md space-y-2 border-2 rounded-xl transition-all ${addedTaskIndices.has(index) ? 'border-green-400 bg-green-50' : 'border-zinc-200'}`}
              >
